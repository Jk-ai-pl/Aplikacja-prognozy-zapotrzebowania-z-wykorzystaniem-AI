...
class Energy:
    def __init__(self, master):
        ...
        self.window.title("Zasoby energetyczne")
    ...
    def generate_forecast(self):
        ...
        self._create_forecast_window(dates, demand, "Prognoza zapotrzebowania na zasoby energetyczne", f"Energetyczne ({unit})", unit)
